...
//		HP600 hp = new HP600();
		...
		Object o1 = new LG500(); // Object 클래스는 제일 꼭대기의 클래스이기 때문에 부모 클래스
		...
		// 		- HP600 x 3대
		// - 매일 업무
		//		- 프린터가 제대로 동작 하는지 기능확인
		
		// 추가상황] LG500 x 500대 , HP600 x 300대
		// 추가상황] BenQ700 , Epson600 -> 추가 브랜드(제품)
...
//	
	...
	@Override
	public void powerOn() {
		System.out.println("프린터 전원을 켭니다."); // 동일한 기능의 내용만 붙여서 넣기
