...
public class Ex36_Class {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	5. 인터페이스
		 		- 캡슐화된 내부와 외부간의 최소한의 연결이 가능하도록 하는 통로 역할
		 		ex) 게임 인터페이스
		 		
		 	
		 	객체 = 데이터 + 행동 의 집합
		 	
		 	리모콘 = 데이터(회색 , 100g , 8cm*17cm..) + 행동(전원 On , 전원 Off , 배터리를 넣는다. 배터리를 뺀다..)
		 	...
		 	8. 상속
		 		- 부모가 가진 재산을 자식이 물려받는 행동
		 		
		 
		 */
		
		
		// 요구사항] 지도 > 우리집 표시 > 좌표 > 저장
		...
		// - 배열 단점 > 요소간의 성질을 구분하기 힘들다. > 첨자는 의미를 가지지 못한다. 
		// > 몇번째 방에 어떤 데이터를 넣었는지 관리 힘들다. > 배열은 같은 타입의 같은 성질의 데이터 집합
		...
		// 학생 성적 > 이름 , 국어 , 영어 , 수학 > 하나의 집합(=학생 1명)
