...
public class Ex73_Lamda {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 사용자 정의 함수 인터페이스 -> 개발자 선언
		 
		 
		 표준 API 함수형 인터페이스
		  1. Consumer -> 매개변수가 있고 반환값이 없는 거
		 	- Consumer<T>
		 	- BiConsumer<T>
		 	- IntConsumer
		 	- 기타등등..
		 	
		 2. Supplier -> 매개변수가 없고 반환값이 있는 거
		 	- Supplier<T>
		 	- 기타등등..
		 	
		 3. Function -> 매개변수도 있고 반환값도 있는 거
		 	- Function<T , R>
		 	- BiFuction<T , U , R>
		 	- 기타등등..
		 
		 4. Operator -> 매게변수도 있고 반환값도 있는 거(Function과 동일)
		 	- BinaryOperator<T>
		 	- Function의 하위셋
		 	- 기타등등..
		 	
		 5. Predicate -> 매개변수도 있고 반환값도 있는 거(Function과 동일)
		 	- Predicate<T>
		 	- Function의 하위셋
		 	- 기타 등등..
...
//		}
	...
	private static void m1() {
		...
		Consumer<Integer> m2 = num -> System.out.println(num * num);
		m2.accept(5);
